...
# Query detailed un-inbounded dispatch orders for Today (2026-08-01)
query = '''
    SELECT 
...
print(f"Total Forecast Rows Query Result: {len(df):,} rows")
...
out_csv = os.path.join(artifact_dir, "danh_sach_chi_tiet_6225_don_forecast_shuttle_linehaul_01082026.csv")
