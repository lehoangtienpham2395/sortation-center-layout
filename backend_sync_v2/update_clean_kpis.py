...
ARTIFACT_DIR = r"C:\Users\lehoa\.gemini\antigravity\scratch\sortation-center-layout"

# Exact PostgreSQL metrics for Today (2026-08-01)
kpi_summary = {
  "op_date": "2026-08-01",
  "contract_version": "2.0.0",
  "inbound_orders": 426,
  "inbound_weight_ton": 4.99,
  "forecast_total": 17504,
  "rot_hom_truoc": 7293,
  "rot_hom_nay": 10211,
  "rot_ton_dong": 0,
...
last_update = {
  "last_update": "17:56:52 01/08/2026",
...
for p in paths:
    ...
    print(f"Updated KPI JSONs in {p}")

print("\nAll KPI JSON files successfully updated with exact PostgreSQL metrics!")
